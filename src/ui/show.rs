    ...
    match &page.show {
        Loadable::Loaded(show) => {
            ...
            ui.horizontal(|ui| {
                ...
                if let Some(latest) = page.episodes.items.first() {
                    ...
                    if app.play_pending(&uri) {
                        ...
                        palette.on_accent,
                        &tr!(app.locale, "Play latest episode"),
                    )
                    .clicked()
                    {
            ...
            if !show.description.is_empty() {
                theme::section_title(ui, &palette, &tr!(app.locale, "About"));
                ui.add_space(4.0);
            ...
            theme::section_title(ui, &palette, &tr!(app.locale, "All episodes"));
            ui.add_space(6.0);
